...
plt.title(f'Mean Augmented Data for Predicted ECSA')
plt.legend()
plt.savefig(f"{DIR_Data}/ECSA_multiple_cut_Mean_Sample_all_ranges{ranges['1300, 1350']}.png")
plt.show()
...
output_file_path = f"{DIR_Data}/ECSA_multiple_cut_all_ranges_mean_data{ranges["1300, 1350"]}.xlsx"
